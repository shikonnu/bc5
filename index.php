...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['h-captcha-response'])) {
    ...
    $data = [
        ...
        'sitekey' => '58e0453e-2302-4f32-b798-309ebc6cf6a6',
    ...
    if ($result !== false) {
        ...
        if ($response['success']) {
            ...
            error_log("hCaptcha errors: " . implode(', ', $error_codes));
        }
    } else {
